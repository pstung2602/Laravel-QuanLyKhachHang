...
@section('content')
    <div class="col-12">
        <div class="row">
            ...
            <a class="btn btn-outline-primary" href="" data-toggle="modal" data-target="#cityModal" style="height: 38px">
                Lọc
            </a>
            <div class="col-6">
            ...
            <a class="btn btn-primary" style="height: 40px;  " href="{{ route('customers.create') }}">Thêm mới</a>
            &nbsp;<a class="btn btn-primary" style="height: 40px;" href="{{ route('customers.index') }}">Back</a>
